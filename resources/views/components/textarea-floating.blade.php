...
@php
    ...
    $baseClasses =
        'block px-4 pb-3 pt-4 w-full text-base text-gray-900 rounded-xl border appearance-none dark:text-white peer transition-colors';
    $activeClasses =
    ...
    $labelBaseClasses =
        'absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] px-2 start-2 rounded-md';
    $labelActiveClasses =
        'bg-white dark:bg-gray-900 peer-focus:px-2 peer-focus:text-indigo-600 peer-focus:dark:text-indigo-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-6 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 cursor-text';
    $labelReadonlyClasses =
        'bg-gray-50 dark:bg-gray-800 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-6 cursor-not-allowed';
