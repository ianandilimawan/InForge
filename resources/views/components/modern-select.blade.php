...
@php
    $baseClasses = 'block w-full rounded-xl border border-zinc-200/80 dark:border-zinc-700/80 bg-zinc-50 dark:bg-zinc-800/80 text-zinc-900 dark:text-white shadow-2xs focus:bg-white dark:focus:bg-zinc-800 focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 py-3 appearance-none transition-all duration-200 cursor-pointer pr-10 text-sm ' . (isset($iconSlot) ? 'pl-11' : 'px-4');
@endphp
