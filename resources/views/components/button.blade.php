...
@php
    $variantClasses = match($variant) {
        ...
        'dark', 'black' => 'text-zinc-100 bg-zinc-900 hover:bg-zinc-800 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-white border border-zinc-800 dark:border-zinc-200',
        ...
        'solid-primary', 'solid-emerald' => 'text-white bg-emerald-600 hover:bg-emerald-700 border border-emerald-600 shadow-sm',
        'solid-blue' => 'text-white bg-blue-600 hover:bg-blue-700 border border-blue-600 shadow-sm',
        'solid-danger' => 'text-white bg-rose-600 hover:bg-rose-700 border border-rose-600 shadow-sm',
