...
<body class="bg-gray-50 dark:bg-gray-900 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-2xl w-full text-center">
        <!-- Error Code -->
        <div class="mb-8">
            <h1 class="text-9xl font-bold text-gray-900 dark:text-white mb-4">503</h1>
        ...
        <div class="mb-8">
            <div
                class="inline-flex items-center justify-center w-32 h-32 rounded-full bg-purple-100 dark:bg-purple-900/20 mb-6">
                <i class="fas fa-tools text-6xl text-purple-600 dark:text-purple-400"></i>
            </div>
        </div>
