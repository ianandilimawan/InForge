    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">View and manage server application error logs</p>
            </div>
        </div>
                            ...
                            Saving...
                                ...
                                <form x-data="ajaxForm" @submit.prevent="submit" method="GET" action="{{ route('admin.laravel-logs.index') }}" class="flex flex-wrap items-center gap-2 w-full md:w-auto">
                                    ...
                                    @if (request()->anyFilled(['level', 'search']))
                                        <a href="{{ route('admin.laravel-logs.index', ['file' => $selectedFile]) }}"
